    ...
    <div className="home">
      ...
      <div className="navbar__topbar">
        <div className="container">
          <p className="navbar__welcome">
            Welcome to Arryn online eCommerce store
          </p>
        </div>
      </div>
      ...
      <div className="arryn-info">
        <div>
          ...
          <p>
            Encuentra el mismo producto en varias tiendas y elige la opción más
            económica.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            Explora productos de múltiples tiendas online en un solo lugar.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            Un chatbot inteligente que te ayuda a encontrar justo lo que
            buscas.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            Selecciona productos con los mejores tiempos y costos de envío.
          </p>
        </div>
        ...
        <div>
          ...
          <h3>Compra Segura</h3>
          <p>
            Te guiamos a tiendas confiables y seguras para tus compras online.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            Recibe sugerencias basadas en reseñas y popularidad del mercado.
          </p>
        </div>
      </div>
      ...
      <div className="info-section">
        ...
        <div className="info-text">
          ...
          <p className="info-subtitle">
            <strong>
              +20 años de experiencia | Más de 100.000 usuarios satisfechos
            </strong>
          </p>
          <p>
            En Arryn entendemos lo difícil que puede ser elegir el producto
            ideal. Por eso, te acompañamos paso a paso con herramientas
            inteligentes, comparaciones de precios y un asistente virtual que te
            ayuda a tomar la mejor decisión.
          </p>
          <p>
            Nuestro objetivo es que tengas claridad, confianza y seguridad en
            tus compras, para transformar tu experiencia online en algo rápido,
            seguro y confiable.
          </p>
        </div>
      </div>
      ...
      <h2 className="pulse-title">
        Más que productos, ofrecemos soluciones que mejoran tu vida.
        <br />
